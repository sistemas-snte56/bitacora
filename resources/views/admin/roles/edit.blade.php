...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="card-text">
                {!! Form::open(['route'=>['admin.roles.update',$role->id], 'method'=>'PATCH']) !!}
                    @csrf
                    <div class="row">
                        <x-adminlte-input name="name"  placeholder="Ingresa el nombre del Rol" 
                            label-class="text-orange" label="Ingresa tu nombre completo" type="text" fgroup-class="col-md-12" :value="old('name', $role->name)" />
                    </div>    
