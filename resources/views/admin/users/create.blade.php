...
@section('content')
    <div class="card">
        <div class="card-header"style="background-color: #ee7a00;">
            <h4 style="color:#FFFFFF;"><strong>NUEVO USUARIOS</strong></h4>
        </div>
        <div class="card-body">
                ...
                {!! Form::open(['route'=>'admin.user.store','method'=>'POST']) !!}
                    ...
                    <div class="row">
                        ...
                        <x-adminlte-input name="email"  placeholder="¿Cúal es tu correo electrónico?" 
                            label-class="text-orange" label="¿Cúal es tu correo electrónico?" type="email" fgroup-class="col-md-12" :value="old('email')" />
